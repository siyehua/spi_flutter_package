...
- (void *)getPageName:(NSDictionary<NSString *, NSNumber *> *)t t2:(NSString *)t2 callback:(MQQFlutterGen_Result<NSString *> *)callback
 {
...
- (void *)getFps:(NSString *)t a:(int )a callback:(MQQFlutterGen_Result<NSNumber *> *)callback
 {
	NSMutableArray *args = [NSMutableArray array];
	[args addObject:t];
	[args addObject:@(a)];
