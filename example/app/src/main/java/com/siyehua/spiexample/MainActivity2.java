...
public class MainActivity2 extends FlutterActivity {
    ...
    private void testMethod() {
        ChannelManager.getChannel(Fps2.class).getFps(new ChannelManager.Result<Double>() {
            @Override
        ...
        ChannelManager.getChannel(Fps2.class).getPageName(new ChannelManager.Result<String>() {
            @Override
        ...
        ChannelManager.getChannel(Fps.class).add();
    }
}